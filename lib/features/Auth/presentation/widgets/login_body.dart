        ...
        children: [
          ...
          Row(
            ...
            Padding(
              ...
              child: Text('or'.tr(context), style: TextStyles.regular16.copyWith(
          ...
          SocialButton(img: AppAssets.googleIcon, text: 'SignWithGoogle'.tr(context), onPressed: (){}),
          SizedBox(
            height: 16.h,
          ),
          SocialButton(img: AppAssets.facebookIcon, text: 'SignWithFaceBook'.tr(context), onPressed: (){}),
          SizedBox(
            height: 16.h,
          ),
          SocialButton(img: AppAssets.appleIcon, text: 'SignWithApple'.tr(context), onPressed: (){}),
        ],
      ),
    );
  }
